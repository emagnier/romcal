...
export type Definition = {
  ...
  /**
   * Link one or multiple Saints, Blessed, or any other celebrations from the Entity
   * catalog.
   */
...
export type EntityOverride = {
  /**
   * Specify the number of persons this entity item is representing.
   */
  count?: CountUnion;
  /**
   * Specify if titles should not be displayed. This can occur when a title is already
   * included in
   * the name of the entity item.
   */
  hide_titles?: boolean | null;
  /**
  ...
  id: string;
  /**
   * The redefined titles of the entity item.
   */
  titles?: TitlesDef;
};
