...
public struct ParticularConfig: Codable, Equatable, Hashable, Sendable {
  ...
  public init(
    epiphany_on_sunday: Bool?, ascension_on_sunday: Bool?, corpus_christi_on_sunday: Bool?,
...
public struct CalendarDefinition: Codable, Equatable, Hashable, Sendable {
  ...
  public init(
    id: CalendarId, metadata: CalendarMetadata, particular_config: ParticularConfig?, parent_calendar_ids: [CalendarId],
...
public enum Precedence: String, Codable, Equatable, Hashable, Sendable {
  ...
  case properSolemnityTitleOrFounderOrPrimaryPatronOfAReligiousOrg4d =
  ...
  case properFeastTitleOrFounderOrPrimaryPatronOfAReligiousOrg8d =
...
public struct Entity: Codable, Equatable, Hashable, Sendable {
  ...
  public init(
    id: EntityId?, type: EntityType?, fullname: String?, name: String?, canonization_level: CanonizationLevel?,
    date_of_canonization: SaintDateDef?, date_of_canonization_is_approximative: Bool?,
    date_of_beatification: SaintDateDef?, date_of_beatification_is_approximative: Bool?, hide_canonization_level: Bool?,
    titles: [Title]?, sex: Sex?, hide_titles: Bool?, date_of_dedication: SaintDateDef?, date_of_birth: SaintDateDef?,
    date_of_birth_is_approximative: Bool?, date_of_death: SaintDateDef?, date_of_death_is_approximative: Bool?,
    count: SaintCount?, sources: [String]?, _todo: [String]?
  ) {
    self.id = id
    self.type = type
...
public struct CelebrationSummary: Codable, Equatable, Hashable, Sendable {
  ...
  public init(
    id: LiturgicalDayId, fullname: String, precedence: Precedence, rank: Rank, rank_name: String, colors: [ColorInfo],
    commons: [CommonInfo], entities: [Entity], titles: TitlesDef, is_holy_day_of_obligation: Bool, is_optional: Bool,
...
public struct ChristmasTimeSeason: Codable, Equatable, Hashable, Sendable {
  ...
  public init(
    season: String?, day: String?, octave: String?, before_epiphany: String?, second_sunday_after_christmas: String?,
...
public struct CyclesMetadata: Codable, Equatable, Hashable, Sendable {
  ...
  public init(
    proper_of_time: String?, proper_of_saints: String?, sunday_year_a: String?, sunday_year_b: String?,
    sunday_year_c: String?, weekday_year_1: String?, weekday_year_2: String?, psalter_week_1: String?,
    psalter_week_2: String?, psalter_week_3: String?, psalter_week_4: String?
  ) {
...
public struct DayDefinition: Codable, Equatable, Hashable, Sendable {
  ...
  public init(
    date_def: DateDef?, date_exceptions: DateDefExceptions?, precedence: Precedence?, commons_def: CommonsDef?,
    is_holy_day_of_obligation: Bool?, allow_similar_rank_items: Bool?, is_optional: Bool?, custom_locale_id: LocaleId?,
    entities: [EntityRef]?, titles: TitlesDef?, drop: Bool?, colors: ColorsDef?, masses: MassesDefinitions?
  ) {
...
public struct ParentOverride: Codable, Equatable, Hashable, Sendable {
  ...
  public init(
    from_calendar_id: CalendarId, date_def: DateDef?, date_exceptions: [DateDefException]?, precedence: Precedence?,
    rank: Rank?, colors: [ColorInfo]?, titles: TitlesDef?, commons_def: [CommonDefinition]?,
    is_holy_day_of_obligation: Bool?, is_optional: Bool?, allow_similar_rank_items: Bool?
  ) {
    self.from_calendar_id = from_calendar_id
    self.date_def = date_def
    self.date_exceptions = date_exceptions
...
public struct LiturgicalDay: Codable, Equatable, Hashable, Sendable {
  ...
  public init(
    id: LiturgicalDayId, fullname: String, date: String, date_def: DateDef, date_exceptions: [DateDefException],
    precedence: Precedence, rank: Rank, rank_name: String, allow_similar_rank_items: Bool,
    is_holy_day_of_obligation: Bool, is_optional: Bool, season: Season?, season_name: String?, periods: [PeriodInfo],
    commons: [CommonInfo], colors: [ColorInfo], masses: [MassInfo], titles: TitlesDef, entities: [Entity],
    week_of_season: UInt32?, day_of_season: UInt32?, day_of_week: DayOfWeek, nth_day_of_week_in_month: UInt8,
    start_of_season: String?, end_of_season: String?, start_of_liturgical_year: String, end_of_liturgical_year: String,
    sunday_cycle: SundayCycle, sunday_cycle_name: String, weekday_cycle: WeekdayCycle, weekday_cycle_name: String,
    psalter_week: PsalterWeekCycle, psalter_week_name: String, from_calendar_id: CalendarId,
...
public struct LocaleColors: Codable, Equatable, Hashable, Sendable {
  ...
  public init(
    black: String?, gold: String?, green: String?, purple: String?, red: String?, rose: String?, white: String?
  ) {
    self.black = black
    self.gold = gold
    self.green = green
...
public struct MassContext: Codable, Equatable, Hashable, Sendable {
  ...
  public init(
    mass_time: MassTime, mass_time_name: String, civil_date: String, liturgical_date: String, season: Season?,
    season_name: String?, sunday_cycle: SundayCycle, sunday_cycle_name: String, weekday_cycle: WeekdayCycle,
    weekday_cycle_name: String, psalter_week: PsalterWeekCycle, psalter_week_name: String, week_of_season: UInt32?,
    day_of_season: UInt32?, day_of_week: DayOfWeek, periods: [PeriodInfo], start_of_season: String?,
    end_of_season: String?, start_of_liturgical_year: String, end_of_liturgical_year: String, id: LiturgicalDayId,
    fullname: String, precedence: Precedence, rank: Rank, rank_name: String, colors: [ColorInfo], commons: [CommonInfo],
    entities: [Entity], titles: TitlesDef, is_holy_day_of_obligation: Bool, is_optional: Bool,
    from_calendar_id: CalendarId, optional_celebrations: [CelebrationSummary]
  ) {
...
public struct PeriodsMetadata: Codable, Equatable, Hashable, Sendable {
  ...
  public init(
    christmas_octave: String?, days_before_epiphany: String?, days_from_epiphany: String?,
    christmas_to_presentation_of_the_lord: String?, presentation_of_the_lord_to_holy_thursday: String?,
    holy_week: String?, paschal_triduum: String?, easter_octave: String?, early_ordinary_time: String?,
    late_ordinary_time: String?
  ) {
...
public struct RanksMetadata: Codable, Equatable, Hashable, Sendable {
  ...
  public init(
    solemnity: String?, sunday: String?, feast: String?, memorial: String?, optional_memorial: String?, weekday: String?
  ) {
...
public struct SeasonsMetadata: Codable, Equatable, Hashable, Sendable {
  ...
  public init(
    advent: AdventSeason?, christmas_time: ChristmasTimeSeason?, ordinary_time: OrdinaryTimeSeason?, lent: LentSeason?,
    paschal_triduum: PaschalTriduumSeason?, easter_time: EasterTimeSeason?
  ) {
    self.advent = advent
...
public struct ResourcesMetadata: Codable, Equatable, Hashable, Sendable {
  ...
  public init(
    ordinal_format: OrdinalFormat?, ordinals_letters: BTreeMap<String, String>?,
    ordinals_numeric: BTreeMap<String, String>?, weekdays: BTreeMap<String, String>?, months: BTreeMap<String, String>?,
    colors: LocaleColors?, seasons: SeasonsMetadata?, periods: PeriodsMetadata?, ranks: RanksMetadata?,
