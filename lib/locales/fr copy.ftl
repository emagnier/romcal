...
advent =
  ...
  .weekday = { WEEKDAY($dow) } de la { ORDINAL($week) }, { "context": "feminine" }) semaine de l’Avent
  .sunday = { ORDINAL($week) }, capitalize) dimanche de l’Avent
  .privileged_weekday = {{day}} $t(months:11)

christmas_time =
  .season = Temps de Noël
  .day = { WEEKDAY($dow) } dans le Temps de Noël
  ...
  .after_epiphany = { WEEKDAY($dow) } après l’Épiphanie

ordinary_time =
  .season = Temps Ordinaire
  .weekday = { WEEKDAY($dow) } de la { ORDINAL($week) }, { "context": "feminine" }) semaine du Temps Ordinaire
  .sunday = { ORDINAL($week) }, capitalize) $t(weekdays:0) du Temps Ordinaire

lent =
  .season = Temps du Carême
  .weekday = { WEEKDAY($dow) } de la { ORDINAL($week) }, { "context": "feminine" }) semaine de Carême
  .sunday = { ORDINAL($week) }, capitalize) dimanche de Carême
  .day_after_ash_wed = { WEEKDAY($dow) } après les Cendres
  .holy_week_day = { WEEKDAY($dow) } Saint
...
easter_time =
  .season = Temps Pascal
  .weekday = { WEEKDAY($dow) } de la { ORDINAL($week) }, { "context": "feminine" }) semaine de Pâques
  .sunday = { ORDINAL($week) }, capitalize) dimanche de Pâques
  .octave = { WEEKDAY($dow) } dans l’Octave de Pâques
...
ORDINAL = { $num ->
   [1] premier
   [1] ordinal__1_feminine = première
   [2] deuxième
   [3] troisième
   [4] quatrième
   [5] cinquième
...
adalbert_of_prague_bishop_patron_of_poland = Saint Adalbert, évêque de Prague, martyr et patron de la Pologne (✝ 997)
...
albert_the_great_bishop = Saint Albert le Grand, frère prêcheur, évêque de Ratisbonne, docteur de l’Église (✝ 1280)
...
andrew_kim_tae_gon_priest_paul_chong_ha_sang_and_companions_martyrs = Saint André Kim Taegon, prêtre, et Paul Chong Ha-sang et ses compagnons, martyrs en Corée (XIXème s.)
andrew_zorard_of_nitra_and_benedict_of_skalka_hermits = Saints André Svorad († 1009) et Benoît Stojislav († 1012), ermites
...
arbogast_of_strassburg_bishop_patron_of_the_diocese_of_strasbourg = Saint Arbogast, évêque, patron du diocèse de Strasbourg (✝ 678)
...
augustine_zhao_rong_priest_and_companions_martyrs = Saints Augustin Zhao Rong et ses compagnons, martyrs en Chine (entre 1648 et 1930)
aurelia_virgin = Sainte Aurélie, vierge
barnabas_apostle = Saint Barnabé, apôtre
bartholomew_apostle = Saint Barthélemy, apôtre
basil_the_great_and_gregory_nazianzen_bishops = Saints Basile le Grand (✝ 379) et Grégoire de Naziance (✝ 390), évêques et docteurs de l’Église
...
benedict_of_nursia_abbot_patron_of_europe = Saint Benoît de Nursie, Patriarche des moines d’Occident, fondateur de l’ordre des Bénédictins et patron de l’Europe (✝ v. 547)
...
bridget_of_sweden_religious_copatroness_of_europe = Sainte Brigitte de Suède, veuve puis religieuse, fondatrice de l’ordre du Saint-Sauveur, co-patronne de l’Europe (✝ 1373)
...
carmelites_of_compiegne_virgins_and_martyrs = Bienheureuses Carmélites de Compiègne : Mère Thérèse et ses 15 compagnes, martyres (guillotinées en 1794)
...
catherine_of_saint_augustine_de_simon_de_longpre_virgin = Bienheureuse Catherine de Saint-Augustin, religieuse hospitalière de la Miséricorde (✝ 1668)
catherine_of_siena_virgin = Sainte Catherine de Sienne, vierge et docteur de l’Église (✝ 1380)
catherine_of_siena_virgin_copatroness_of_europe = Sainte Catherine de Sienne, vierge, docteur de l’Église, co-patronne de l’Europe (✝ 1380)
catherine_of_siena_virgin_copatroness_of_italy_and_europe = Sainte Catherine de Sienne, vierge, docteur de l’Église, co-patronne de l’Italie et de l’Europe (✝ 1380)
...
cornelius_i_pope_and_cyprian_of_carthage_bishop_martyrs = Saints martyrs Corneille, pape, et Cyprien, évêque (IIIème s.)
...
cyril_the_philosopher_monk_and_methodius_of_thessaloniki_bishop = Saints Cyrille, Moine, et Méthode, évêque, apôtres des Slaves au IXème siècle
cyril_the_philosopher_monk_and_methodius_of_thessaloniki_bishop_copatrons_of_europe = Saints Cyrille, Moine, et Méthode, évêque, apôtres des Slaves au IXème siècle, co-patrons de l’Europe
...
denis_of_paris_bishop_patron_of_the_diocese_of_saint_denis = Saint Denis, évêque et martyr, patron de la ville et du diocèse de Saint-Denis
...
eugene_de_mazenod_bishop = Saint Eugène de Mazenod, fondateur des Oblats de Marie-Immaculée, évêque de Marseille (✝ 1861)
...
francis_of_assisi_patron_of_italy = Saint François d’Assise, fondateur de l’ordre des Frères mineurs, patron de l’Italie (✝ 1226)
...
joachim_and_anne_patroness_of_the_province_of_quebec_parents_of_mary = Saints Anne, patronne de la province civile de Québec, et Joachim, parents de la vierge Marie (Ier siècle)
...
john_baptist_de_la_salle_priest = Saint Jean-Baptiste de La Salle, prêtre et fondateur des Frères des Écoles Chrétiennes (✝ 1719)
...
john_de_brebeuf_isaac_jogues_priests_and_companions_martyrs = Saints Jean de Brébeuf, Isaac Jogues, prêtres Jésuites, et leurs compagnons, martyrs (XVIIème siècle)
john_de_brebeuf_isaac_jogues_priests_and_companions_martyrs_copatrons_of_canada = Saints Jean de Brébeuf, Isaac Jogues, prêtres Jésuites, et leurs compagnons, martyrs, co-patrons du Canada (XVIIème siècle)
...
julie_billiart_virgin = Sainte Julie Billiart, religieuse, fondatrice de l’Institut des Sœurs de Notre-Dame (✝ 1816)
...
lawrence_ruiz_and_companions_martyrs = Saints Laurent Ruiz et 15 compagnons, martyrs à Nagasaki au Japon (✝ v. 1635)
...
marcellinus_of_rome_and_peter_the_exorcist_martyrs = Saints martyrs Marcellin, prêtre, et Pierre, Exorciste (✝ 304)
...
marguerite_bourgeoys_virgin = Sainte Marguerite Bourgeoys, religieuse, fondatrice de la congrégation des Sœurs de Notre-Dame (✝ 1700)
marguerite_dyouville_religious = Sainte Marguerite d’Youville, religieuse, fondatrice des Sœurs de la Charité de Montréal (✝ 1771)
...
marie_de_la_providence_virgin = Bienheureuse Marie de la Providence (Eugénie Smet), vierge, fondatrice de la congrégration des Auxilliatrices († 1871 à Paris)
marie_de_incarnation_religious = Bienheureuse Marie de l‘Incarnation, Carmélite à Pontoise († 1618)
marie_eugenie_milleret_virgin = Sainte Marie-Eugénie Milleret, vierge, fondatrice des Sœurs de l’Assomption († 1898 à Paris)
...
martha_of_bethany_mary_of_bethany_and_lazarus_of_bethany = Saints Marthe, Marie et Lazare, disciples du Christ (Ier s.)
...
maternus_of_cologne_and_valerius_of_treves_and_eucharius_first_apostles_of_alsace = Les premiers Apôtres de l‘Église en Alsace : Saints Materne, Valère et Euchaire
...
pothinus_of_lyon_bishop_blandina_of_lyon_virgin_and_companions_martyrs = Saint Pothin, évêque, Sainte Blandine, vierge, et leurs 46 compagnons, martyrs à Lyon (✝ 177)
...
stanislaus_of_szczepanow_bishop_patron_of_poland = Saint Stanislas, évêque de Cracovie, martyr et patron de la Pologne (✝ 1079)
...
teresa_benedicta_of_the_cross_stein_virgin = Sainte Thérèse-Bénédicte de la Croix (Edith Stein), Carmélite, martyr en Pologne (✝ 1942)
teresa_benedicta_of_the_cross_stein_virgin_copatroness_of_europe = Sainte Thérèse-Bénédicte de la Croix (Edith Stein), Carmélite, martyr en Pologne, co-patronne de l’Europe (✝ 1942)
teresa_of_jesus_of_avila_virgin = Sainte Thérèse de Jésus (d’Avila), vierge et docteur de l’Église (✝ 1582)
therese_of_the_child_jesus_and_the_holy_face_of_lisieux_virgin = Sainte Thérèse de l’Enfant-Jésus, vierge et docteur de l’Église (✝ 1897)
therese_of_the_child_jesus_and_the_holy_face_of_lisieux_virgin_copatroness_of_france = Sainte Thérèse de l’Enfant-Jésus, vierge, docteur de l’Église, co-patronne de la France (✝ 1897)
...
timothy_of_ephesus_and_titus_of_crete_bishops = Saints Timothée et Tite, évêques, disciples et compagnons de Saint Paul (Ier s.)
...
vincent_de_paul_priest = Saint Vincent de Paul, prêtre, fondateur de la congrégation de la Mission et des Filles de la Charité (✝ 1660)
...
wenceslaus_i_of_bohemia_martyr_patron_of_the_czech_nation = Saint Venceslas, martyr et patron de la nation tchèque (✝ 929)
