...
export const locale: Locale = {
  ...
  names: {
    ...
    christ_the_king_sunday: 'Ježíše Krista krále',
    christmas: 'Narození Páně',
    corpus_christi: 'Těla a krve Páně',
    divine_mercy_sunday: 'Neděle Božího milosrdenství',
    ...
    columba_of_iona_abbot_copatron_of_ireland: 'Sv. Kolumby, Abbot, Missionary and Copatron of Ireland',
    ...
    cyril_the_philosopher_monk_and_methodius_of_thessaloniki_bishop: 'Sv. Cyrila, mnicha, a Metoděje, biskupa',
    ...
    cyril_the_philosopher_monk_and_methodius_of_thessaloniki_bishop_slavic_missionaries:
      'Sv. Cyrila a Metoděje, slovanských věrozvěstů',
    ...
    guardian_angels: 'Svatých andělů strážných',
    ...
    hedwig_of_silesia: 'Sv. Hedviky, řeholnice',
    ...
    muredach_of_killala_bishop: 'Sv. Muredacha, bishop',
    ...
    pius_of_pietrelcina_priest: 'Sv. Pia z Pietrelciny, kněze',
    ...
    presentation_of_mary: 'Zasvěcení Panny Marie v Jeruzalémě',
    procopius_of_sazava_abbot: 'Sv. Prokopa, opata',
    publius_of_malta_bishop: 'Sv. Publia, biskupa',
    queenship_of_mary: 'Panny Marie Královny',
    ...
    wendelin_of_trier_abbot: 'Sv. Vendelína, opata',
    ...
    wladyslaw_of_gielniow_priest: 'Bl. Vladislava z Gielniówa, kněze',
