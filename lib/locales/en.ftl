...
advent__weekday =  { WEEKDAY($dow) } of the { ORDINAL($week) } week of Advent
advent__sunday = { ORDINAL($week) } Sunday of Advent
advent__privileged_weekday = { MONTH(11) } { $day }

# Christmas Time

christmas_time__season = Christmas Time
christmas_time__day = { WEEKDAY($dow) } of Christmas Time
christmas_time__octave = { $count }º Day within the Octave of the Nativity of the Lord
christmas_time__second_sunday_after_christmas = Second Sunday after the Nativity of the Lord
christmas_time__before_epiphany = { MONTH(0) } { $day }
christmas_time__after_epiphany = { WEEKDAY($dow) } after the Epiphany of the Lord

# Ordinary Time

ordinary_time__season = Ordinary Time
ordinary_time__weekday = { WEEKDAY($dow) } of the { ORDINAL($week) }) week of Ordinary Time
ordinary_time__sunday = { ORDINAL($week) }, capitalize) Sunday in Ordinary Time

# Lent

lent__season = Lent
lent__weekday = { WEEKDAY($dow) } of the { ORDINAL($week) }) week of Lent
lent__sunday = { ORDINAL($week) }, capitalize) Sunday of Lent
lent__day_after_ash_wed = { WEEKDAY($dow) } after Ash Wednesday
lent__holy_week_day = { WEEKDAY($dow) } of Holy Week

# Paschal Triduum

paschal_triduum__season = Paschal Triduum

# Easter Time

easter_time__season = Easter Time
easter_time__weekday = { WEEKDAY($dow) } of the { ORDINAL($week) }) week of Easter
easter_time__sunday = { ORDINAL($week) }, capitalize) Sunday of Easter
easter_time__octave = { WEEKDAY($dow) } within the Octave of Easter


# PERIODS

period__epiphany = Epiphany
period__holy_week = Holy Week


# RANKS

rank__solemnity = solemnity
rank__sunday = Sunday
rank__feast = feast
rank__memorial = memorial
rank__weekday = weekday
...
adelphus_bishop = Saint Adolph, Bishop
...
amandus_first_bishop_of_strasbourg = Saint Amand, First Bishop of Strasbourg
amarin_abbot = Saint Amarin, Abbot and Martyr
...
arbogast_of_strassburg_bishop = Saint Arbogast, Bishop
arbogast_of_strassburg_bishop_patron_of_the_diocese_of_strasbourg = Saint Arbogast, Bishop, Patron of the diocese of Strasbourg
...
aurelia_virgin = Saint Aurelia, Virgin
...
catherine_laboure_virgin = Saint Catherine Labouré, Religious
...
ceran_of_paris_bishop = Saint Céran of Paris, Bishop
...
dedication_of_the_cathedral_of_strasbourg = Dedication of the Cathedral of Strasbourg
...
denis_of_paris_bishop_patron_of_the_diocese_of_paris = Saint Denis, Martyr, First bishop, Patron of the diocese
denis_of_paris_bishop_patron_of_the_diocese_of_saint_denis = Saint Denis, Bishop and Martyr,Patron of the city and the diocese of Saint-Denis
...
eucharius_of_treves_bishop = Saint Eucharius, Bishop
eugenie_and_attale_of_alsace = Saint Eugenie et Saint Attale, Virgin
...
frederic_ozanam = Blessed Frederic Ozanam, Founder
...
jean_georges_rehm_priest_and_martyr = Blessed Jean-Georges Rehm, Priest and Martyr
...
leodegar_bishop_and_martyr = Saint Leodegar, Bishop and Martyr
...
louise_of_marillac = Saint Louise of Marillac, Religious
...
ludan_pilgrim = Saint Ludan, Pilgrim
...
marcel_of_paris_bishop = Saint Marcel of Paris, Bishop
...
marie_eugenie_milleret_virgin = Saint Marie-Eugénie de Jésus, Religious and Founder
marie_de_la_providence_virgin = Blessed Marie de la Providence, Virgin
marie_de_incarnation_religious = Blessed Marie de l‘Incarnation, Religious
...
mary_refuge_of_sinner = Holy Mary, Refuge of Sinner
marie_rose_durocher_virgin = Blessed Marie Rose Durocher, Virgin
marie_therese_de_soubiran_virgin = Blessed Marie-Thérèse de Soubiran, Virgin
...
maternus_of_cologne_and_valerius_of_treves_and_eucharius_first_apostles_of_alsace = The first Apostles of the Church of Alsace : Saints Maternus, Valere and Euchaire
...
modeste_andlauer_and_andre_bauer_martyrs = Saints Modeste Andlauer and André Bauer, Martyrs
monica_of_hippo = Saint Monica
moninne_of_killeavy_virgin = Saint Moninne, Virgin
modeste_andlauer_martyr = Saint Modeste Andlauer, Martyr
morandus_of_cluny_monk = Saint Morandus, Monk
...
nicholas_barre = Blessed Nicholas Barré, Priest
...
richardis_of_swabi = Saint Richardis, Empress
...
rosalie_rendu_virgin = Blessed Rosalie Rendu, Virgin
...
urban_i_pape = Saint Urban I, Pope and Martyr
...
valerius_of_treves_bishop = Saint Valerius, Bishop
...
wenceslaus_i_of_bohemia_martyr_patron_of_the_czech_nation = Saint Wenceslaus, Martyr and patron of the Czech nation
wendelin_of_trier_abbot = Saint Wendelin, Hermit and Abbot
