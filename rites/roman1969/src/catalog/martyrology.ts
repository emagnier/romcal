...
export const Martyrology: { catalog: MartyrologyCatalog } = {
  catalog: {
    ...
    anne_mother_of_mary: {
      canonizationLevel: CanonizationLevels.Saint,
      name: 'Anne',
      titles: [Title.ParentsOfTheBlessedVirginMary],
      dateOfDeath: {
        century: 1,
      },
    },
    ...
    catherine_of_siena_virgin: {
      ...
      titles: [Title.Virgin, Title.DoctorOfTheChurch],
      dateOfDeath: 1380,
    },
    ...
    fridolin_of_sackingen_monk: {
      ...
      titles: [Title.Monk, Title.Missionary],
      dateOfDeath: '540-3-6',
      dateOfDeathIsApproximative: true,
    },
    // src:
    ...
    fursa_of_peronne_abbot: {
      canonizationLevel: CanonizationLevels.Saint,
      name: 'Fursa',
      titles: [Title.Abbot, Title.Missionary],
    },
    gabriel_archangel: {
      canonizationLevel: CanonizationLevels.Saint,
      name: 'Gabriel',
    ...
    gregory_i_the_great_pope: {
      ...
      titles: [Title.Pope, Title.DoctorOfTheChurch],
      dateOfDeath: 604,
    },
    ...
    irenaeus_of_lyon_bishop: {
      canonizationLevel: CanonizationLevels.Saint,
      name: 'Irenaeus',
      titles: [Title.Bishop, Title.Martyr, Title.DoctorOfTheChurch],
      dateOfBirth: 130,
      dateOfBirthIsApproximative: true,
      dateOfDeath: 201,
      dateOfDeathIsApproximative: true,
    ...
    john_apostle: {
      canonizationLevel: CanonizationLevels.Saint,
      name: 'John',
      titles: [Title.Apostle, Title.Evangelist],
    },
    ...
    marie_eugenie_of_jesus_milleret_de_brou_virgin: {
      canonizationLevel: CanonizationLevels.Saint,
      name: 'Marie-Eugénie of Jesus Milleret de Brou',
      titles: [Title.Virgin],
      dateOfDeath: 1898,
    },
    ...
    marthe_aimee_adele_le_bouteiller_virgin: {
      ...
      name: 'Martha Aimée-Adèle le Bouteiller',
      titles: [Title.Virgin],
    ...
    martyrs_of_the_french_revolution: {
      name: 'Martyrs of the French Revolution',
      titles: [Title.Martyr],
      dateOfDeath: {
    ...
    mary_of_the_incarnation_barbara_acarie_religious: {
      canonizationLevel: CanonizationLevels.Blessed,
      name: 'Mary of the Incarnation Barbara Acarie',
      titles: [Title.Religious],
      dateOfDeath: 1618,
    },
    mary_of_the_incarnation_marie_guyart_religious: {
      canonizationLevel: CanonizationLevels.Saint,
      name: 'Mary of the Incarnation Marie Guyart',
      titles: [Title.Religious],
      dateOfDeath: 1672,
    },
    mary_of_the_providence_eugenie_smet_virgin: {
      canonizationLevel: CanonizationLevels.Blessed,
      name: 'Mary of the Providence Eugénie Smet',
      titles: [Title.Virgin],
      dateOfDeath: 1871,
    },
    ...
    our_lady_queen_of_poland: {
      name: 'Our Lady',
      titles: [Title.QueenOfPoland],
    },
    our_lady_refuge_of_sinners: {
      name: 'Our Lady, Refuge of Sinners',
    },
    ...
    valerius_of_trier_bishop: {
      canonizationLevel: CanonizationLevels.Saint,
      name: 'Valerius of Trier',
      titles: [Title.Bishop],
      dateOfDeath: 320,
    },
    ...
    wendelin_of_trier_hermit: {
      ...
      titles: [Title.Hermit, Title.Abbot],
      dateOfDeath: 617,
    },
