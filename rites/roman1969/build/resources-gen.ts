...
import { locale as enLocale } from '../src/locales/en';
...
const martyrologyFilePath = join(__dirname, '..', 'src', 'catalog', 'martyrology.ts');
const martyrologyContent = readFileSync(martyrologyFilePath, 'utf8');

// Read the content of the en.ts file to extract sources
const enLocaleFilePath = join(__dirname, '..', 'src', 'locales', 'en.ts');
